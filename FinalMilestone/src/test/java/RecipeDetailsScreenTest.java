...
WebElement categoriesrecyclerViewElement = driver.findElement(By.id("recyclerview"));
		...
		// details screne test starts 
		
		
		WebElement recipeImageViewElement = driver.findElement(By.id("recipeImageView"));
		
		if(recipeImageViewElement.isDisplayed()) {
			System.out.println("Recipe Image is visible");
		}
		
		
		WebElement titleTextViewElement2 = driver.findElement(By.id("titleTextView"));
		
		if(titleTextViewElement2.isDisplayed()) {
			System.out.println("Recipes title displayed");
		}
		
		WebElement ingredientsTextViewElement = driver.findElement(By.id("ingredientsTextView"));
		
		if(ingredientsTextViewElement.isDisplayed()) {
			System.out.println("Recipe ingredients displayed");
		}
		
		WebElement instructionsTextViewElement = driver.findElement(By.id("instructionsTextView"));
		
		if(instructionsTextViewElement.isDisplayed()) {
			System.out.println("Recipe instructions displayed");
		}
