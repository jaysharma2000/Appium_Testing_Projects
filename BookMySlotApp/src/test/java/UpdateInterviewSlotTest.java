...
public class UpdateInterviewSlotTest {
...
private AppiumDriver driver;
	...
	public void addinterviewSlotTest() throws InterruptedException{
		...
		WebElement interviewNameTextView = driver.findElement(By.id("interviewNameTextView"));
		if(interviewNameTextView.isDisplayed()) {
			interviewNameTextView.click();
			System.out.println("Clicked on interview slot and navigated to the update interview slots screen");
		}
		
		Thread.sleep(1500);
		
		WebElement designationEditText2 = driver.findElement(By.id("designationEditText"));
		
		if(designationEditText2.isDisplayed()) {
			designationEditText2.sendKeys("IOS Developer");
			System.out.println("Designation updated!");
		}
		
		WebElement updateSlotButton = driver.findElement(By.id("updateSlotButton"));
		
		if(updateSlotButton.isDisplayed()) {
			updateSlotButton.click();
			System.out.println("Interview slot updated successfully");
		}
	}
